...
#define epsilon 50 // increment value
...
void sync(int core_num) {
    // sync core 0
    if(!core_num) {
        if(STATE_0_cycle == 1 && count_0_c >= pow(sqrt(46080) - epsilon, 2) - 6080) {
            STATE_0_cycle = 0;
            STATE_0 = 0;
            count_0 = 0;
            count_0_c = 0;
        } else if (STATE_0_cycle == 1 && count_0_c < pow(sqrt(46080) - epsilon, 2) - 6080) {
            STATE_0_cycle = 1;
            STATE_0 = 0;
            count_0 = 0;
    ...
    // sync core 1
        ...
        if(STATE_1_cycle == 1 && count_1_c >= pow(sqrt(46080) - epsilon, 2) - 6080) {
            STATE_1_cycle = 0;
            STATE_1 = 0;
            count_1 = 0;
            count_1_c = 0;
        } else if (STATE_1_cycle == 1 && count_1_c < pow(sqrt(46080) - epsilon, 2) - 6080) {
            STATE_1_cycle = 1;
            STATE_1 = 0;
            count_1 = 0;
