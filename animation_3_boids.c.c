...
void boid_initialize(struct Boid* b);
void boid_initialize(struct Boid* b) {
    (*b).pos_x = 0;
    (*b).pos_y = 0;
    (*b).vx = 0;
...
static PT_THREAD (protothread_anim(struct pt *pt))
{
    ...
    // Spawn a boid
    boid_initialize(&boid0);
    boid_initialize(&boid1);
    boid_initialize(&boid2);
    ...
    while(1) {
      ...
      // erase boid
      drawRect(fix2int15(boid0.pos_x), fix2int15(boid0.pos_y), 2, 2, BLACK);
      drawRect(fix2int15(boid1.pos_x), fix2int15(boid1.pos_y), 2, 2, BLACK);
      drawRect(fix2int15(boid2.pos_x), fix2int15(boid2.pos_y), 2, 2, BLACK);
