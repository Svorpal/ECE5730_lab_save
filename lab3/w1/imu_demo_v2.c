...
void on_pwm_wrap() {
    ...
    accel_angle = multfix15(divfix(acceleration[0], acceleration[1]), float2fix15(180.0/3.14)) ;

    // Gyro angle delta (measurement times timestep) (15.16 fixed point)
    gyro_angle_delta = multfix15(gyro[2], float2fix15(0.01)) ;

    // Complementary angle (degrees - 15.16 fixed point)
    complementary_angle = multfix15(complementary_angle - gyro_angle_delta, float2fix15(0.99)) + multfix15(accel_angle, float2fix15(0.01));
